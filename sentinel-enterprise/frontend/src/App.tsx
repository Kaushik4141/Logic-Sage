    ...
    <TooltipProvider delayDuration={0}>
      <div className="dark h-screen w-full bg-background text-foreground font-sans overflow-hidden flex">
        ...
        <main className="flex-1 min-h-0 flex overflow-hidden">
          ...
          <div className="flex-1 flex flex-col relative overflow-hidden min-h-0 bg-background">
            {/* Header */}
            <header className="flex h-11 items-center justify-between px-6 border-b border-border bg-background/50 backdrop-blur-sm sticky top-0 z-10 font-sans shrink-0">
              ...
              <div className="flex-1 flex justify-center px-4 max-w-sm mx-auto">
                <div className="relative w-full group">
                  <Search className="absolute left-2.5 top-1.5 h-3.5 w-3.5 text-muted-foreground group-focus-within:text-primary transition-colors" />
                  <Input
                    ref={searchInputRef}
                    type="search"
                  ...
                  <div className="absolute right-2 top-1.5 hidden items-center gap-1 sm:flex pointer-events-none opacity-40 group-focus-within:opacity-0 transition-opacity">
                    <kbd className="h-4 px-1.5 flex items-center rounded border border-border bg-muted font-mono text-[9px] font-medium text-muted-foreground">
                      <span className="text-[10px] mr-0.5">Ctrl + </span>K
                    </kbd>
                  </div>
                </div>
              </div>
